    ...
    <div className="min-h-screen bg-[#181818] text-or-light py-20 px-4">
      ...
      <section className="max-w-4xl mx-auto mb-10">
        <h2 className="text-or font-bold text-2xl mb-4 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">flag</span>
          Notre mission
        </h2>
        ...
        <h2 className="text-or font-bold text-2xl mb-4 mt-8 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">favorite</span>
          Nos valeurs
        </h2>
        ...
        <div className="border-t border-[#232323] my-8"></div>
        <h2 className="text-or font-bold text-2xl mb-4 mt-8 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">verified_user</span>
      ...
      <section className="max-w-4xl mx-auto mb-16">
        <h2 className="text-or font-bold text-2xl mb-6 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">timeline</span>
          Notre histoire
        </h2>
      ...
      <section className="max-w-4xl mx-auto mb-16">
        <h2 className="text-or font-bold text-2xl mb-6 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">stars</span>
          Notre différence
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="flex items-start gap-4">
            <span className="material-icons text-or text-3xl">rocket_launch</span>
            <div>
          ...
          <div className="flex items-start gap-4">
            <span className="material-icons text-or text-3xl">person_search</span>
            <div>
          ...
          <div className="flex items-start gap-4">
            <span className="material-icons text-or text-3xl">lock</span>
            <div>
          ...
          <div className="flex items-start gap-4">
            <span className="material-icons text-or text-3xl">eco</span>
            <div>
      ...
      <section className="max-w-4xl mx-auto mb-16">
        <h2 className="text-or font-bold text-2xl mb-6 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">groups</span>
          Équipe dirigeante
        </h2>
      ...
      <section className="max-w-4xl mx-auto mb-20">
        <h2 className="text-or font-bold text-2xl mb-6 flex items-center gap-2">
          <span className="material-icons text-or-light text-xl align-middle">bar_chart</span>
          Chiffres clés
        </h2>
